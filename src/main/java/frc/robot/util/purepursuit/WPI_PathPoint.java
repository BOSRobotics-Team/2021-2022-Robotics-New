...
/**
 * This class is the datastructure used to parse WPILib Path json files into something Lib5K
 * understands. The fields of this class must match the JS object fields from the json files.
 */
